...
function renderSVG({ totalContributions, streaks, joinYear }) {
  ...
  <!-- Total Contributions -->
  <g transform="translate(74.5, 26)" style="opacity:0; animation: fadein 0.5s ease forwards 0.2s">
  ...
  <text x="82.5" y="80" text-anchor="middle" class="num" fill="#70a5fd" style="opacity:0; animation: fadein 0.5s ease forwards 0.3s">${totalContributions}</text>
  <text x="82.5" y="116" text-anchor="middle" class="label" style="opacity:0; animation: fadein 0.5s ease forwards 0.4s">Total Contributions</text>
  <text x="82.5" y="146" text-anchor="middle" class="range" style="opacity:0; animation: fadein 0.5s ease forwards 0.5s">${totalRange}</text>

  <!-- Current Streak -->
  <circle cx="247.5" cy="71" r="40" fill="none" stroke="#70a5fd" stroke-width="5" style="opacity:0; animation: fadein 0.5s ease forwards 0.3s"/>
  <g transform="translate(247.5, 19.5)" style="opacity:0; animation: popin 0.6s ease forwards 0.5s">
  ...
  <text x="247.5" y="80" text-anchor="middle" class="num" fill="#bf91f3" style="opacity:0; animation: fadein 0.5s ease forwards 0.6s">${current}</text>
  <text x="247.5" y="140" text-anchor="middle" class="label" style="opacity:0; animation: fadein 0.5s ease forwards 0.7s">Current Streak</text>
  <text x="247.5" y="166" text-anchor="middle" class="range" style="opacity:0; animation: fadein 0.5s ease forwards 0.8s">${currentRange}</text>

  <!-- Longest Streak -->
  <g transform="translate(404.5, 24)" style="opacity:0; animation: fadein 0.5s ease forwards 0.6s">
  ...
  <text x="412.5" y="80" text-anchor="middle" class="num" fill="#70a5fd" style="opacity:0; animation: fadein 0.5s ease forwards 0.7s">${longest}</text>
  <text x="412.5" y="116" text-anchor="middle" class="label" style="opacity:0; animation: fadein 0.5s ease forwards 0.8s">Longest Streak</text>
  <text x="412.5" y="146" text-anchor="middle" class="range" style="opacity:0; animation: fadein 0.5s ease forwards 0.9s">${longestRange}</text>
</svg>
`
}
